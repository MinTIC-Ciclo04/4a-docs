...
class TestAPI(TestCase):
    ...
    def test_signUp(self):
        ...
        response = client.post(
            '/user/',
            {
                ...
                "nombres": "user prueba",
                "apellidos" : "user prueba",
                "noIdentificacion" : "user prueba",
                "direccion" : "user prueba",
                "telefono" : "user prueba",
                "email" : "user_prueba_1@resya.com",
    ...
    def test_user(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data["username"], "gero")